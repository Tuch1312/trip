...
public class TransitDetails implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(departure_stop).append(" at ").append(departure_time);
        sb.append(" -> ");
        sb.append(arrival_stop).append(" at ").append(arrival_time);
        if (headsign != null) {
        ...
        sb.append(", ").append(num_stops).append(" stops");
