...
public class RottaAdapter extends GenericAdapter {
    ...
    public List<Rotta> getByViaggio() {
        return null;
    }//TODO getByViaggio (rotta))

    public Rotta getById() {
        return null;
    }//TODO getById (rotta))

    public Rotta getByPartenza() {
        return null;
    }//TODO getByPartenza (rotta))

    public Rotta getByArrivo() {
        return null;
    }//TODO getByArrivo (rotta))
